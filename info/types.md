...
The standard tactic for achieving these goals "dynamic" languages is to write a
...
type variable `z` and variable `y`. You can extend HM-type algorithms to
...
variables if having a string on either side of an assignment "infect" both
sides.
